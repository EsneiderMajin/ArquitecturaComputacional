...
void keypad_init(void){
    ...
    TRISA &= ~(1<<PA5) & ~(1<<PA6) & ~(1<<PB2) & ~(1<<PB3);
    TRISA |= (1<<4) | (1<<5) | (1<<6) | (1<<7);
    INTCON2bits.RBPU = 0;
}
...
for(i=0;i<4;i++){
   ...
   if(i==0){
      ...
      LATA = (1<<7)|(1<<6)|(1<<5)|(1<<4)|(1<<3)|(1<<2)|(1<<1)|(0<<0);
   ...
   if(i==1){
      LATA = (1<<7)|(1<<6)|(1<<5)|(1<<4)|(1<<3)|(1<<2)|(0<<1)|(1<<0);
      _delay((unsigned long)((100)*(8000000/4000000.0)));
   ...
   if(i==2){
      LATA = (1<<7)|(1<<6)|(1<<5)|(1<<4)|(1<<3)|(0<<2)|(1<<1)|(1<<0);
      _delay((unsigned long)((100)*(8000000/4000000.0)));
   ...
   if(i==3){
      LATA = (1<<7)|(1<<6)|(1<<5)|(1<<4)|(0<<3)|(1<<2)|(1<<1)|(1<<0);
      _delay((unsigned long)((100)*(8000000/4000000.0)));
