...
void PrenderLed(_Bool TemperaturaAdecuada,_Bool HumedadAdecuada);
...
void PrenderLed(_Bool TemperaturaAdecuada,_Bool HumedadAdecuada){
    LedsIniciar();
    if(TemperaturaAdecuada==0 && HumedadAdecuada==0){
       LATE0=1;
    }else if(TemperaturaAdecuada==0 || HumedadAdecuada==0){
        LATE1=1;
    }else{
        LATE2=1;
    }
