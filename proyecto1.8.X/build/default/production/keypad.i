...
for(i=0;i<4;i++){
   ...
   if(i==0){
      ...
      LATD = (1<<7)|(1<<6)|(1<<5)|(1<<4)|(1<<3)|(1<<2)|(1<<1)|(0<<0);
      _delay((unsigned long)((100)*(8000000/4000000.0)));
      while (!(PORTD & (1<<4))){valor=letras[0][0];}
      while (!(PORTD & (1<<5))){valor=letras[0][1];}
      while (!(PORTD & (1<<6))){valor=letras[0][2];}
      while (!(PORTD & (1<<7))){valor=letras[0][3];}
   }

   if(i==1){
      LATD = (1<<7)|(1<<6)|(1<<5)|(1<<4)|(1<<3)|(1<<2)|(0<<1)|(1<<0);
      _delay((unsigned long)((100)*(8000000/4000000.0)));
      while (!(PORTD & (1<<4))){valor=letras[1][0];}
      while (!(PORTD & (1<<5))){valor=letras[1][1];}
      while (!(PORTD & (1<<6))){valor=letras[1][2];}
      while (!(PORTD & (1<<7))){valor=letras[1][3];}
   }

   if(i==2){
      LATD = (1<<7)|(1<<6)|(1<<5)|(1<<4)|(1<<3)|(0<<2)|(1<<1)|(1<<0);
      _delay((unsigned long)((100)*(8000000/4000000.0)));
      while (!(PORTD & (1<<4))){valor=letras[2][0];}
      while (!(PORTD & (1<<5))){valor=letras[2][1];}
      while (!(PORTD & (1<<6))){valor=letras[2][2];}
      while (!(PORTD & (1<<7))){valor=letras[2][3];}
   }

   if(i==3){
      LATD = (1<<7)|(1<<6)|(1<<5)|(1<<4)|(0<<3)|(1<<2)|(1<<1)|(1<<0);
      _delay((unsigned long)((100)*(8000000/4000000.0)));
      while (!(PORTD & (1<<4))){valor=letras[3][0];}
      while (!(PORTD & (1<<5))){valor=letras[3][1];}
      while (!(PORTD & (1<<6))){valor=letras[3][2];}
      while (!(PORTD & (1<<7))){valor=letras[3][3];}
      }
   }
